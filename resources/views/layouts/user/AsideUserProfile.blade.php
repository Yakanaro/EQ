...
<aside id="default-sidebar" class="z-40 w-64 h-auto w-auto transition-transform -translate-x-full sm:translate-x-0 flex" aria-label="Sidebar">
        ...
        <ul class="space-y-2 font-medium">
            <li>
                <a href="/me" class="flex items-center p-2 text-gray-900 rounded-lg hover:bg-gray-100">
                    ...
                    <span class="ml-3 ">{{ Auth::user()->name }} {{ Auth::user()->surname }}</span>
                </a>
            </li>

            <li class="bg-transparent">
                <a href="/progress" class="flex items-center p-2 mt-[45px] text-gray-900 rounded-lg hover:bg-gray-100">
            ...
            <li>
                <a href="/settings" class="flex items-center p-2 text-gray-900 rounded-lg hover:bg-gray-100">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
