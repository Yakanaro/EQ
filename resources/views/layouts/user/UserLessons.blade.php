...
<div class="flex flex-col-2 bg-transparent">
    <aside id="default-sidebar" class="bg-transparent mr-0 w-64 transition-transform -translate-x-full sm:translate-x-0 " aria-label="Sidebar">
        <div class="h-full px-3 py-4 overflow-y-auto bg-transparent bg-transparent">
            <ul class="space-y-2 font-medium bg-transparent">
                <li class="bg-transparent">
                    <a href="/me" class="flex items-center p-2 text-gray-900 rounded-lg hover:bg-gray-100">
                        <span class="ml-3">Дружинин Сергей</span>
                    </a>
                </li>
                <li >
                    <a href="/progress" class="flex items-center p-2 mt-[35px] text-gray-900 rounded-lg hover:bg-gray-100">
