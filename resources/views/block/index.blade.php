...
{{--    <div class="grid grid-cols-2 justify-items-center gap-5 mx-4 mb-4">--}}
...
{{--                <div class="p-5">--}}
{{--                    <a href="{{ route('blocks.show', $block->id) }}">--}}
{{--                        <h5 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">{{$block->title}}</h5>--}}
{{--                    </a>--}}
...
{{--                            <span class="mt-1.5 inline-flex items-center justify-center w-6 h-6 mr-2 text-sm font-semibold text-gray-800 bg-green-500 rounded-full dark:bg-gray-700 dark:text-gray-300">--}}
